...
const Hero = () => {
  return (
    <section className="relative bg-transparent font-sans flex flex-col justify-start min-h-screen">
      {/* Content Section */}
      <div className="relative text-center max-w-3xl px-4 sm:px-6 pt-10 md:pt-24 lg:pt-32 pb-16 sm:pb-20 md:pb-24 lg:pb-28 z-10 mx-auto">
